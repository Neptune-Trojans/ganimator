...
datagen_corps_name = ['bone_spine', 'bone_thigh_left', 'bone_shin_left', 'bone_foot_left', 'bone_toe_left', 'bone_toe_left_end', 'bone_thigh_right',
                      'bone_shin_right', 'bone_foot_right', 'bone_toe_right', 'bone_toe_right_end', 'bone_spine_001', 'bone_spine_002', 'bone_spine_003',
'bone_shoulder_left',
'bone_upper_arm_left',
'bone_forearm_left',
'bone_hand_left',
'bone_palm_01_left',
'bone_f_index_01_left',
'bone_f_index_02_left',
'bone_f_index_03_left',
'bone_f_index_03_left_end',
'bone_thumb_01_left',
'bone_thumb_02_left',
'bone_thumb_03_left',
'bone_thumb_03_left_end',
'bone_palm_02_left',
'bone_f_middle_01_left',
'bone_f_middle_02_left',
'bone_f_middle_03_left',
'bone_f_middle_03_left_end',
'bone_palm_03_left',
'bone_f_ring_01_left',
'bone_f_ring_02_left',
'bone_f_ring_03_left',
'bone_f_ring_03_left_end',
'bone_palm_04_left',
'bone_f_pinky_01_left',
'bone_f_pinky_02_left', 'bone_f_pinky_03_left', 'bone_f_pinky_03_left_end', 'bone_spine_004', 'bone_neck', 'bone_head', 'bone_head_end',
'bone_shoulder_right',
'bone_upper_arm_right',
'bone_forearm_right',
'bone_hand_right',
'bone_palm_01_right',
'bone_f_index_01_right',
'bone_f_index_02_right',
'bone_f_index_03_right',
'bone_f_index_03_right_end',
'bone_thumb_01_right',
'bone_thumb_02_right',
'bone_thumb_03_right',
'bone_thumb_03_right_end',
'bone_palm_02_right',
'bone_f_middle_01_right',
'bone_f_middle_02_right',
'bone_f_middle_03_right',
'bone_f_middle_03_right_end',
'bone_palm_03_right',
'bone_f_ring_01_right',
'bone_f_ring_02_right',
'bone_f_ring_03_right',
'bone_f_ring_03_right_end',
'bone_palm_04_right',
'bone_f_pinky_01_right',
'bone_f_pinky_02_right',
'bone_f_pinky_03_right', 'bone_f_pinky_03_right_end', 'bone_pelvis_left', 'bone_pelvis_left_end', 'bone_pelvis_right', 'bone_pelvis_right_end',
]
...
datagen_contact_name = [name for name in datagen_corps_name if 'toe' in name or 'foot' in name]


class SkeletonDatabase:
    names = ['Mixamo', 'Elephant', 'Crab_dance', 'Xia', 'Datagen']
    corps_names = [mixamo_corps_name, elephant_corps_name, crab_dance_corps_name, xia_corps_name, datagen_corps_name]
    contact_names = [mixamo_contact_name, elephant_contact_name, crab_dance_contact_name, xia_contact_name, datagen_contact_name]
